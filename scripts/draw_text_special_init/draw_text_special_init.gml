///
/// @description Singleton script that will create the global icon lookup table if it has not yet
///  been created. The intention of the table is to provide a fast way for finding sprite resources
