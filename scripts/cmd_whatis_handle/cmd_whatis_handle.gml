///
/// @desc                Handles the "whatis" chat command.
/// @param {string} noun The first (and only) argument of the command specifying the noun that
///                      should be described.
///
function cmd_whatis_handle(noun) {
